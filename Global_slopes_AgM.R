...
#Ryield<-((rastcrop[[4]]*ArNewr[[3]]+rastcrop[[8]]*ArNewi[[3]])*10/ArNew[[3]])/(2*0.446*0.87)
Ryield<-((rastcrop[[8]]*ArNewr[[3]]+rastcrop[[4]]*ArNewi[[3]])*10/ArNew[[3]])/(2*0.446*0.87)
...
Gyield<-data.frame("Year"=c(1980:2010),"WYield"=WGlobY, "MYield"=MGlobY, "RYield"=RGlobY)
Global_data_A[[a]]<-Gyield



Gyield<-subset(Gyield,Year>1981)
